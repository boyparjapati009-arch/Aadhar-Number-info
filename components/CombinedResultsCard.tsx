...
const DetailItem: React.FC<{ label: string; value: string }> = ({ label, value }) => (
  <div className="py-3 border-b border-slate-200 dark:border-slate-700/50 break-words">
    <p className="text-sm text-slate-500 dark:text-slate-400">{label.replace(/[\u{1F600}-\u{1F64F}]/gu, '').trim()}</p>
  ...
  return (
    <div className="w-full p-1 rounded-2xl bg-gradient-to-br from-emerald-500/50 to-teal-500/50 hover:shadow-2xl hover:shadow-emerald-500/20 transition-shadow duration-500 animate-result-appear">
      <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-[14px] p-6 sm:p-8">
        ...
        <div className="mb-10">
            <h2 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-500">
