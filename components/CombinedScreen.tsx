  ...
  return (
    <>
      <header className="text-center mb-10">
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight bg-gradient-to-r from-emerald-500 to-teal-600 text-transparent bg-clip-text">
          Full Profile Finder
        </h1>
      ...
      <div className="w-full mt-8">
        {isLoading && (
          <div className="text-center animate-fade-in">
            <Loader />
            <p className="mt-2 text-slate-500 dark:text-slate-400">{loadingStep}</p>
          </div>
        )}
        {error && !isLoading && (
